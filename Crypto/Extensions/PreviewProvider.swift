...
extension PreviewProvider {
    // Return static variable 扩展PreviewProvider 相当于动态添加了一个属性
    static var dev: DeveloperPreivew {
        return DeveloperPreivew.instance
    }
}


// use singleton
class DeveloperPreivew {
...
//    func instance() -> DeveloperPreivew.self {
//        return instance;
//    }
